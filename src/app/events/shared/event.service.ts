...
//Siempre es una buena practica al hacer un servicio marcarlo, como tal
import { Subject, Observable } from 'rxjs';
import { IEvent, ISession } from './event.model';

//Este decorador no es necesario justo para este ejemplo, pero es necesario para cuando los servicios inyectan otras dependencias
@Injectable()
